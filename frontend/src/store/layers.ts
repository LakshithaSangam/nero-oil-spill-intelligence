...
const DEFAULTS: LayerDef[] = [
  ...
  D({ id: "currents", label: "Ocean currents", group: "environment", swatch: "layer-forecast", visible: true, adjustable: false, desc: "Real surface current data, drifting streaks show which way the water is actually moving right now." }),
